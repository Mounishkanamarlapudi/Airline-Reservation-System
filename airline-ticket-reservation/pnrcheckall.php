...
<center><img src='images/front.jpg' class='img-thumbnail' width='1200px' style='height:130px;'></center>";
  ...
  <div class="container-fluid">
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <center><font style="font-family:Verdana; font-size:18px;">
                   PSMK Airlines <br>
			Passanger Details for PNR Number
                    </font></center>
		...
		______________________________________________________________________
                   ...
                   <?php
                    ...
                    while($row1 = mysqli_fetch_array($result1))
                      {                  
                        ...
                        echo "<center><img src='images/psmk1.jpg' class='img-thumbnail' width='180px' style='height:180px;'></center>";
                        echo"<div>";
                      }
                   ?>
                        </td>
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td><font style="font-family: Verdana;"> Frequent Flight No. (If any)</font></td>
