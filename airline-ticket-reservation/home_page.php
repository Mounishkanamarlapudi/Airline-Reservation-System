...
<html>
	<head>
		<title>
			Welcome to  PSMK Airlines
		</title>
		<link rel="stylesheet" type="text/css" href="css/style.css"/>
		<link rel="stylesheet" href="font-awesome-4.7.0\css\font-awesome.min.css">
	</head>
	<body>
		<img class="logo" src="images/psmk3.jpg"/> 
		<h1 id="title">
			PSMK Airways
		</h1>
		<div>
...
<li><a href="pnrall.php"><i class="fa fa-ticket" aria-hidden="true"></i> Check PNR </a></li>
		...
		<div class="container">
			<div class="welcome_text">Welcome to PSMK AIRLINES !</div>
			<img src=":\xampp\htdocs\airline-ticket-reservation\airline-ticket-reservation\images\new.jpeg" width=100%>
		</div>
